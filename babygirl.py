...
┏━━━━━━━━━━━━━━━━┓
┣★
┣★ ᴅᴇᴠᴇʟᴏᴘᴇʀ : [Abduazimov](tg://user?id=1305987911)
┣★
...
START_BUTTONS = InlineKeyboardMarkup(
    [
        ...
        [
            ...
            InlineKeyboardButton("✗ ᴅᴇᴠᴇʟᴏᴘᴇʀ ✗", url="https://t.me/abduazimov74")
        ],
        [
...
BUTTONS = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton(text="✗ ᴅᴇᴠᴇʟᴏᴘᴇʀ ✗", url="https://t.me/Abduazimov74")
        ]
    ]
)
...
async def video_play(_, message):
    ...
    try:
        ...
        try:
            ...
            if ice == "0":
                return await m.edit("» ɴᴏᴛ ғᴏᴜɴᴅ, ᴛʀʏ sᴇᴀʀᴄʜɪɴɢ ᴡɪᴛʜ ᴛʜᴇ sᴏɴɢ ɴᴀᴍᴇ!")               
    except Exception as e:
...
async def skip(_, message):
    ...
    if len(message.command) < 2:
        ...
        if op == 0:
            await message.reply_text("» ɴᴏᴛʜɪɴɢ ɪs ᴘʟᴀʏɪɴɢ ᴡʜᴀᴛ ᴛᴏ sᴋɪᴘ 🥲")
        elif op == 1:
...
async def end(_, message):
    ...
    if chat_id in QUEUE:
        await app.leave_group_call(chat_id)
        clear_queue(chat_id)
        await message.reply_text("» sᴛʀᴇᴀᴍ ᴇɴᴅᴇᴅ ʙʏ {} 🥺".format( message.from_user.mention ), )
    else:
        await message.reply_text("» ɴᴏᴛʜɪɴɢ ɪs ᴘʟᴀʏɪɴɢ 🥱")
